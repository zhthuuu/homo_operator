  ...
  maxpf(maxpf_i)
{
  ...
  // srandom(::time(0));        // initialize the random number generator in second
  struct timeb timeSeed;
  ftime(&timeSeed);
  srandom(timeSeed.time*1000+timeSeed.millitm); // initialize the random number generateor in milli second
