function WEFF = NL2DSOLVER(FIXEDNODES, p,  NE, GDOF, ND, g, bulk, shear, sb, sc, Ae, DOFe, ISPARSE, JSPARSE, KSPARSE)
...
while (FLAG10 == 1)
    ...
    DISPDD = zeros(GDOF, 1);
        ...
        while (FLAG20 == 1)
            ...
            [X, Y] = mex_HYPER2D(NE,bulk, shear,sb,sc,Ae,GDOF,DOFe,DISPTD);
...
%WEFF = EFFSEF_CPP(DISPTD, NE,  bulk, shear, sb, sc, Ae, DOFe);
WEFF = mex_EFFSEF(DISPTD, NE,  bulk, shear, sb, sc, Ae, DOFe);
